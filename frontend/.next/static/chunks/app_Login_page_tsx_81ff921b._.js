...
function LoginPage() {
    ...
    const handleLogin1 = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:3000/login', {
                email,
                senha
            });
...
_s(LoginPage, "zeMEujHHLM6S2ugnKlR2uiKlBdU=");
_c = LoginPage;
var _c;
